...
public:
  ...
  int Exec()
  {
    std::cout << "Cyclic solution 8: "  << std::endl;
    int i = 0;
    math::solver::Cyclic<Vect> itSolver;
    //Create the matrix
    double dataA[] = 
    {
      10, 4, 2, 4, 2,
    ...
    //call solve 
    itSolver.Solve();
    std::cout << " Cyclic method solves in " << itSolver.NIter() << " iterations." << std::endl;
