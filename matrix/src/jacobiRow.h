...
#ifndef _MATH_SOLVER_JACOBIROW_h
#define _MATH_SOLVER_JACOBIROW_h
...
class JacobiRow : public RowSolver<Storage, T>
{
...
public:
  void Exec()
  {
    T res = dot( m_idx, *m_x, *m_row ) + dot( *m_x, *m_row, m_idx + 1 );
...
#ifdef MYDEBUG
  friend class JacobiRowTest;
#endif //MYDEBUG
};

}/*solver*/ }/*math*/ 

#endif /*_MATH_SOLVER_JACOBIROW_h */
