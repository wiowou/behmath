...
#ifndef _MATH_MODEL_BC_HEATFLUX_h
#define _MATH_MODEL_BC_HEATFLUX_h
...
class HeatFlux : public BoundaryCondition
{
...
public:
  void Apply( Face* f1)
  {
    ...
    double q = hflux(f1->ctr[0], f1->ctr[1], f1->ctr[2], time);
    double QA = q * f1->area;
...
#ifdef MYDEBUG
  friend class HeatFluxTest;
#endif //MYDEBUG
};

}/*bc*/ }/*model*/ }/*math*/ 

#endif /*_MATH_MODEL_BC_HEATFLUX_h */
